...
class _call(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        if type(r) == bool: return r
        elif r is None: return self.obj
        else: return _(r)
...
# ------------------------------------ number ------------------------------------
    ...
    def even (self): return self._%2 == 0

    def odd (self): return not self.even()
...
def _uniq (data): return list(CL.OrderedDict.fromkeys(data).keys())
